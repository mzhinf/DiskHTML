...
DiskHTML 是面向 Windows 10/11 的目录快照与 SHA-256 比对工具。桌面程序只负责选择输入、扫描并生成报告；目录树、搜索、排序、详情和比对状态在可离线打开的 HTML 中查看。
...
- 记录 Name、Size、Modified、Created、SHA-256、卷信息和可选物理磁盘信息。
...
2. “生成比对报告”：选择基准快照、快照内目录、待检查目录和输出报告。
